      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="../userlogin/feedback">Leave Feedback</a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo $member->email;?>"><?php echo $member->email;?></a></li>
                <li><a href="../userlogin/logout">Log out </a></li>
                <li><li><a href="../userlogin/feedback">leave feedback</a></li>
    ...
    <div class="col-xs-3 col-sm-4 sidebar-offcanvas" id="sidebar" role="navigation">
      ...
      <div class="container">
    	<div class="panel panel-default ">
		  ...
		  <div class="panel-heading"><h2>______</h2></div>
		  <!-- Table -->
